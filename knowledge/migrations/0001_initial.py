    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.TextField(help_text='Please offer details of this topic.', null=True, verbose_name='Description', blank=True)),
                ('status', models.CharField(default=b'internal', max_length=32, verbose_name='Status', db_index=True, choices=[(b'public', 'Public'), (b'private', 'Private'), (b'internal', 'Internal')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Enter your first and last name.', max_length=64, null=True, verbose_name='Name', blank=True)),
                ('email', models.EmailField(help_text='Enter a valid email address.', max_length=254, null=True, verbose_name='Email', blank=True)),
                ('body', models.TextField(help_text='Please enter your response.', null=True, verbose_name='Response', blank=True)),
